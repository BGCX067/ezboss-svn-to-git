...
require_once(EZBOSS_CLASSES_PATH  . DIRECTORY_SEPARATOR . 'plugin/Apache/Solr/Document.php');
require_once(EZBOSS_CLASSES_PATH  . DIRECTORY_SEPARATOR . 'plugin/Apache/Solr/Response.php');
